...
resource keyVault 'Microsoft.KeyVault/vaults@2022-07-01' = {
  name: '${abbreviations.keyVaultVaults}${environmentName}-${substring(uniqueIdentifierForResourcesName, 0, 12)}' // 24 - length(abbreviations.keyVaultVaults) - length(environmentName)
  location: location
  tags: tags
  properties: {
